...
//                       <input
//                         type="number"
//                         value={editedValues[`${milestone}_Achievement`]}
//                         onChange={(e) => handleChange(`${milestone}_Achievement`, e.target.value)}
...
//                           editedValues[`${milestone}_Achievement`],
//                           rowData[milestone]
//                         )}
//                       </div>
//                     </div>
