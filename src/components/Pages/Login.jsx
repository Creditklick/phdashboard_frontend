...
const Login = () => {
  ...
  const { setUser, setIsAuthenticated, setIsAuthenticatedAgent } =
    ...
    try {
      if (step === 1) {
        const response = await axios.post(
          "https://phdashboard-backend.onrender.com/ph/api/login",
          formData
        );
        ...
        await verifyOtp(formData.email, otp, formData.ims_id);
      }
    } catch (error) {
  ...
  const verifyOtp = async (email, otp, ims_id) => {
    try {
      const response = await axios.post(
        "https://phdashboard-backend.onrender.com/ph/api/verify",
        {
          email,
          otp,
          ims_id,
  ...
  const resendOtp = async () => {
    try {
      const response = await axios.post(
        "https://phdashboard-backend.onrender.com/ph/api/resendOtp",
        {
        ...
        <div className="hidden lg:flex flex-col justify-center items-center w-1/2 p-8 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-lg">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Transform your product management with our cutting-edge dashboard
              solution
            </p>
              ...
              <div className="relative bg-gradient-to-br from-gray-800/40 to-gray-900/60 backdrop-blur-xl rounded-3xl p-8 border border-gray-700/50 shadow-2xl overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      onChange={(e) =>
                        setFormData({ ...formData, ims_id: e.target.value })
                      }
                      type="text"
                      placeholder="Enter your imsId"
                    ...
                    <div className="flex gap-6 justify-center">
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <div className="relative">
                          ...
                          />
                          <div
                            className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all duration-300 group-hover:border-cyan-400 ${
