...
import { FiUser, FiLock, FiMoon, FiShield, FiHelpCircle, FiLogOut } from 'react-icons/fi';
      ...
      <div className="w-full mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            {activeTab === 'profile' && (
              <div className={`rounded-xl p-6 shadow-lg ${theme}`}>
                  ...
                  <div className="md:w-1/3">
                    <div className="flex flex-col items-center">
                      <div className="relative">
                        <div className={`w-32 h-32 rounded-full ${darkMode ? 'bg-gray-700' : 'bg-gray-200'} flex items-center justify-center overflow-hidden`}>
                  ...
                  <div className="md:w-2/3">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input 
                          type="text" 
                          className={`w-full p-3 rounded-lg border ${darkMode ? 'border-gray-600 bg-gray-700' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:outline-none`}
                          placeholder="John"
                        />
                      </div>
                      <div>
                ...
                <div className="flex justify-end gap-4">
                  <button className={`px-5 py-2 rounded-lg border ${darkMode ? 'border-gray-600 hover:bg-gray-700' : 'border-gray-300 hover:bg-gray-100'} transition-colors`}>
                    Cancel
                  </button>
                ...
                <div className="space-y-6">
                  <div className={`p-5 rounded-lg ${darkMode ? 'bg-gray-700' : 'bg-gray-50'}`}>
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center">
                        <span className={`mr-3 text-sm ${!darkMode ? 'text-blue-500' : 'text-gray-500'}`}>
                          Light
                        </span>
                        <button 
                        ...
                        <span className={`ml-3 text-sm ${darkMode ? 'text-blue-500' : 'text-gray-500'}`}>
                          Dark
                        </span>
                      </div>
                    </div>
            ...
            {/* Privacy Section */}
            {activeTab === 'privacy' && (
              <div className={`border ${darkMode ? 'border-gray-600' : 'border-gray-200'} rounded-xl p-6 shadow-md text-left mx-auto ${theme}`}>
                ...
                <p className={`text-xs mt-6 italic ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              ...
              <div className={`rounded-xl p-6 shadow-lg ${theme}`}>
                ...
                <div className={`p-5 rounded-lg ${darkMode ? 'bg-gray-700' : 'bg-gray-50'}`}>
                  ...
                  <p className={`mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                    If you need assistance, please contact our support team at support@example.com or call us at +1 (555) 123-4567.
                  </p>
                  <h3 className="font-semibold mb-4 mt-6">FAQs</h3>
                  <div className="space-y-3">
                    <div className={`p-3 rounded-lg ${darkMode ? 'bg-gray-600' : 'bg-white'} shadow`}>
                      <h4 className="font-medium">How do I reset my password?</h4>
                      <p className={`text-sm mt-1 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        Go to the Security tab and click on "Change Password" to reset your password.
                      </p>
                    </div>
                    <div className={`p-3 rounded-lg ${darkMode ? 'bg-gray-600' : 'bg-white'} shadow`}>
                      <h4 className="font-medium">How do I enable dark mode?</h4>
                      <p className={`text-sm mt-1 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        Navigate to Preferences and toggle the theme switch to enable dark mode.
                      </p>
                    </div>
                  </div>
                </div>
